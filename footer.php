...
<br><br><br>
    ...
    <div class=" kilimanjaro_bottom_header_one section_padding_50 text-center">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p>© 1990-<script>document.write(new Date().getFullYear());</script>All Rights Reserved by <a href="#">PcTools Inc.<i class="fa fa-love"></i></a></p>
                    <div class="text-center p-3">
                        <p>PcTools, no confies y no compres y el que aconseja no es traidor</p>
                    </div>
                </div>
            </div>
        </div>
