...
if (!isset($_SESSION['usuario'])){
    header("Location:scr/error/index.html");
}
        ...
        <div class="e-panel card">
          <div class="card-body">
            <div class="card-title">
              <h6 class="mr-2"><span>Admin</span><small class="px-1">Se un administrador responsable </small></h6>
            </div>
            <div class="e-table">
              <div class="table-responsive table-lg mt-3">
                ...
                <?php foreach (selectAll() as $row) { ?>
                    <tr>
                      ...
                      <td class="text-nowrap align-middle"><?php echo $row ["nombre_corto"];?></td>
                      <td class="text-nowrap align-middle"><input type="text" value="<?php echo $row ["descripcion"];?>" disabled="disabled" style="border: none;border-color: transparent;"></td>
                      <td class="text-nowrap align-middle"><span><?php echo $row ["PVP"];?></span></td>
                      <td class="text-center align-middle">
                        <div class="btn-group align-top">
                            <a href="scr/php/crud-edit.php?cod=<?php echo $row ["cod"];?>" class="btn btn-sm btn-outline-secondary badge">Edit</a>
        ...
        <div class="card">
          <div class="card-body">
            <div class="text-center px-xl-3">
              <button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#user-form-modal">Añadir Producto</button>
            </div>
            <hr class="my-3">
            ...
            <input type='submit' name='desconectar' class="btn btn-primary btn-block" value='Desconectar <?php echo $_SESSION['usuario']; ?>' />
            </form>
              <!-- <button class="btn btn-primary btn-block" type="button" data-toggle="modal" data-target="#user-form-modal">Desconectar</button> -->
            </div>
          </div>
        </div>
      </div>
